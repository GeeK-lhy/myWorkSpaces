...
<script type="text/javascript">
	$(function(){
		$("#number").focusout(function(){
			var value=$(this).val()
			$.post("checkNumber",{"Mobile_Number":value},function(data){
				$("#span1").html(data);
			})
		})
	});
  ...
  <TR vAlign=top>
    <TD height="600" bgColor=#f1f3f9>
     ...
     <form method="POST" action="saveUser">
      <p>手机号码：<input type="text" name="Mobile_Number" id="number" size="20"><span id="span1"></span> </p>
      ...
      <p>客户ID：<input type="text" name="customer_Id" size="20" value="${customer_Id}" readonly></p>
