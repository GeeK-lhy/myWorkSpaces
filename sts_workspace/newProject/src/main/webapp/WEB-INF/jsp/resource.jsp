...
<TABLE cellSpacing=0 cellPadding=0 width=749 border=0>
  ...
  <TR vAlign=top>
    ...
    <p>号码类型：<input type="radio" name="mobile_Type"  checked value="SIM">SIM &nbsp;&nbsp;<input type="radio" name="mobile_Type" value="UIM" >UIM</p>
    <p>指定号段：从<input type="text" name="start" size="20" >到<input type="text" name="end" size="20" >
