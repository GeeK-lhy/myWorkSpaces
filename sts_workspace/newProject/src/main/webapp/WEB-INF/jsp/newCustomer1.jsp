...
<TABLE cellSpacing=0 cellPadding=0 width=749 border=0>
  ...
  <TR vAlign=top>
    ...
    <form method="POST" action="addCustomer2">
      <p>证件类型：${id_Type}</p><input type="hidden" name="id_Type" value="${id_Type}">
      <p>证件号码：${id_Number}</p><input type="hidden" name="id_Number" value="${id_Number}">
      <p>姓名：<input type="text" name="customer_Name" size="20"></p>
      <p>性别：<input type="radio"  checked name="customer_Sex"">男&nbsp;&nbsp; <input type="radio" name="customer_Name"" >女</p>
      <p>生日：<input type="text" name="customer_Birthday" size="20" ></p>
      <p>联系地址：<input type="text" name="customer_Address" size="20"></p>
      <p>　</p>
