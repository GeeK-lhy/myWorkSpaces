...
<TABLE cellSpacing=0 cellPadding=0 width=749 border=0>
  ...
  <TR vAlign=top>
    ...
    <form method="POST" action="addNewCustomer1">
      <p>证件类型：<select size="1" name="id_Type">
        <option >居民身份证</option>
        <option>护照</option>
        <option>军官证</option>
      </select></p>
      <p>证件号码：<input type="text" name="id_Number" size="20" ></p>
      
      <p>　</p>
      <p><input type="submit" value="下一步>>" name="B1"><input type="reset" value="全部重写" name="B2"></p>
   	  <p ><font style="color: red; ">${nubmerNum}</font></p>
    </form>
