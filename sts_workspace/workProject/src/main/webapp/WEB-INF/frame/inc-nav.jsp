...
<!-- 		<li><span class="folder">订单模块</span>
			<ul>
            	<li><span class="file"><a onclick="urlTarget('pages/ordersys/order/list');">订单管理</a></span></li>
				<li><span class="file"><a onclick="urlTarget('pages/ordersys/order/orderchecklist');">订单审核</a></span></li>
		  </ul>
	  </li>
	<li><span class="folder">配件模块</span>
			<ul>
            	<li><span class="file"><a onclick="urlTarget('pages/partssys/parts/partslist');">配件管理</a></span></li>
				<li><span class="file"><a onclick="urlTarget('pages/partssys/partsrep/partsreplist');">配件出入库管理</a></span></li>
				<li><span class="file"><a onclick="urlTarget('pages/partssys/partsrepbill/partsrepbilllist');">配件出入库流水查询</a></span></li>
		  </ul>
	  </li> -->
		<c:forEach items="${sessionScope.menuList }" var="l" >
			<c:if test="${l.parentMenu==0 }">
				<li><span class="folder">${l.menuName}</span>
			<ul>
            	<c:forEach items="${l.children}" var="c">
            	<li><span class="file"><a onclick="urlTarget('${c.url}');">${c.menuName }</a></span></li>
            	</c:forEach>
		  </ul>
	  </li>
			</c:if>
