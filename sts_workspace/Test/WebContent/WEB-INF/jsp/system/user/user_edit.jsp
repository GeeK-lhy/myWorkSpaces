						...
						<div class="col-xs-12">
								<form action="user/${msg }.do" name="userForm" id="userForm" method="post">
									...
									<table id="table_report" class="table table-striped table-bordered table-hover">
										...
										<c:if test="${uuser.GRADENAME=='admin'}">
										<tr>
											<td style="width:79px;text-align: right;padding-top: 13px;">单位:</td>
											<td>
											
												<select name="GRADENAME" multiple="" class="chosen-select form-control" id="form-field-select-4" data-placeholder="">
										...
										<c:if test="${uuser.GRADENAME!='admin' }">
											<input type="hidden" name="GRADENAME" value="${uuser.GRADENAME }">
										</c:if>
										<tr>
