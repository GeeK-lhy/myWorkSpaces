		...
		<table style="width:99%;margin-top: 12px;margin-left: 9px;">
			...
			<tr>
				<td style="text-align: center;">
					...
					<label style="float:left;padding-left: 32px;"><input name="form-field-radio" id="form-field-radio1" onclick="setType('1');" class="ace"  type="radio" value="icon-edit"><span class="lbl">短信接口1</span></label>
					<label style="float:left;padding-left: 5px;"><input name="form-field-radio" id="form-field-radio2" onclick="setType('2');" class="ace" checked="checked" type="radio" value="icon-edit"><span class="lbl">短信接口2</span></label>
