			...
			<div class="main-content-inner">
				<div class="page-content">
					<div class="row">
						<div class="col-xs-12">
							<div>  
								<c:if test="${userRoleId ne 4 }">
				
									<input type="button" id="uploadFile"  width="200px" height="100px" onclick="upload()"value="上传资料">
								</c:if>
							...
							<div id="uploadDiv" style="display: none;">
								...
								<form method="post" action="trainingmaterials/upload.do" enctype="multipart/form-data">
									上传人 ：<input type="text" name="userName" value="${sessionScope.sessionUser.NAME}"/><br/>
										...
										<div class="usual">
											...
											<div id="idTab1" class="tabssection"> 
												<div class="css-scrollbar simple">
													<!-- 这里可以从后台读数据 循环开始 -->
													<c:forEach items="${vedioList}" var="vl">
													
													<a onclick="newVideo('<%=basePath%>${vl.link}')" class="toc" style="cursor:pointer;">
														<span class="thumb"><img src="plugins/fhplayer/images/videoPic.jfif" alt="" /></span>
														<span class="desc"><span class="title">${vl.name }</span>
							...
							<p>
								<input type="text" class="videourl2" style="width:500px;padding-top: 0px;margin-top: 10px;" placeholder="视频地址" value="视频地址">
							...
							<table class="table table-striped table-bordered table-hover" >
								<tr>
									...
									<td>
										 <a href="http://www.ckplayer.com/manualX/" target="_blank">《手册》</a>查看
									</td>
								</tr>
							</table>
							</div>
