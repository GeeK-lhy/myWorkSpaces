...
<table bgcolor="#E3E4D8" width="100%">
	<tr>
		<td>纬度：</td>
		<td><input id="ZUOBIAO_X" value="${pd.zbx }" type="text"  /></td>
		<td>经度：</td>
		<td><input id="ZUOBIAO_Y" value="${pd.zby }" type="text" /></td>
		<td><input type="button" value="确定" onclick="choose();"/></td>
		<td width="100">
		<input type="text" id="suggestId" size="20" value="这里输入搜索地址" style="width:150px;" /><div id="searchResultPanel" style="border:1px solid #C0C0C0;width:150px;height:auto;"></div>
		</td>
	</tr>
</table>
</div>
...
var points=new BMap.Point($("#ZUOBIAO_Y").val(),$("#ZUOBIAO_X").val())
var map = new BMap.Map("allmap");
map.centerAndZoom(points,12);                   // 初始化地图,设置城市和地图级别。
